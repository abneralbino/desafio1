...
let vacantes = parseInt(prompt("Cuantas vacantes hay que llenar para este puesto?"));

alert("El puesto " + tituloDeLaPosicion + " ID " + id + " se ha registrado exitosamente y hay " + vacantes + " para llenar.")
